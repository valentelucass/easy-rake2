...
<body>
    <div class="app-container">
        <?php include '../src/includes/header-caixa-aberto.php'; ?>
        <main id="main-content" class="dashboard-main">
            <div class="content-container">
                <?php
                if ($tab === 'fechamento') {
                    include '../src/includes/fechamento.php';
                } else if ($tab === 'rake') {
                    include '../src/includes/rake.php';
                } else if ($tab === 'fichas') {
                    include '../src/includes/fichas.php';
                } else if ($tab === 'caixinhas') {
                    include '../src/includes/caixinhas.php';
                } else if ($tab === 'gastos') {
                    include '../src/includes/gastos.php';
                } else if ($tab === 'jogadores') {
                    include '../src/includes/jogadores-caixa.php';
                } else if ($tab === 'inventario') {
                    include '../src/includes/inventario.php';
                }
                ?>
            </div>
        </main>
