...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function carregarCaixinhas() {
    fetch('../src/api/caixas/caixinhas_listar.php')
      .then(r => r.json())
      .then(json => {
        if (!json.success) {
  ...
  function carregarInclusoes(id) {
    return fetch('../src/api/caixas/caixinhas_listar_inclusoes.php?id_caixinha=' + id)
      .then(r => r.json())
      .then(json => {
  ...
  formCriar.onsubmit = function(e) {
    ...
    fetch('../src/api/caixas/caixinhas_criar.php', {
      method: 'POST',
  ...
  formAdicionar.onsubmit = function(e) {
    ...
    fetch('../src/api/caixas/caixinhas_incluir_valor.php', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  function abrirModalDetalhes(id) {
    fetch('../src/api/caixas/caixinhas_listar_inclusoes.php?id_caixinha=' + id)
      .then(r => r.json())
      .then(json => {
  ...
  function excluirInclusao(id_inclusao, id_caixinha) {
    fetch('../src/api/caixas/caixinhas_excluir_inclusao.php', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
