...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function abrirModalEdicaoJogador(jogadorId) {
        fetch('api/jogadores/buscar_jogadores.php?id=' + jogadorId)
            .then(r => r.json())
            .then(data => {
        ...
        document.querySelectorAll('.btn-excluir-jogador').forEach(btn => {
            btn.onclick = function() {
                ...
                if (confirm('Tem certeza que deseja excluir este jogador?')) {
                    fetch('api/jogadores/excluir_jogador.php', {
                        method: 'POST',
    ...
    if(btnNovoJogador && modalJogador && fecharModalJogador && formJogador) {
        ...
        formJogador.onsubmit = function(e) {
            ...
            let url = 'api/jogadores/registrar_jogador.php';
            let method = 'POST';
            if (editId) {
    ...
    if (formQuitar) {
        formQuitar.onsubmit = function(e) {
            ...
            fetch('api/jogadores/quitar_saldo.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(dados)
            })
