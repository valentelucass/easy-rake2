...
class GastosManager {
    ...
    async registrarGasto(e) {
        ...
        try {
            const response = await fetch('api/caixas/registrar_gasto.php', {
                method: 'POST',
                headers: {
    ...
    async carregarGastos() {
        try {
            const response = await fetch('api/caixas/listar_gastos.php');
            const result = await response.json();
    ...
    async confirmarExclusao() {
        ...
        try {
            const response = await fetch('api/caixas/excluir_gasto.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async imprimirReciboGasto(gasto) {
        try {
            const response = await fetch('api/caixas/imprimir_recibo_gasto.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async imprimirTodasGastos() {
        try {
            const response = await fetch('api/caixas/imprimir_todas_gastos.php', {
                method: 'POST'
            });
