...
try {
    $sql = "SELECT * FROM jogadores WHERE deleted_at IS NULL ORDER BY created_at DESC";
    ...
    sendResponse(true, "Jogadores listados com sucesso", 200, $data);
} catch (Exception $e) {
    error_log("Erro ao listar jogadores: " . $e->getMessage());
