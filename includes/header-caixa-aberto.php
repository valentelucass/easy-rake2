...
<header class="header header--caixa-aberto">
    <div class="header__container">
        ...
        <nav class="header__nav-caixa-menu">
            <a href="caixa-aberto-dashboard.php?id=<?= $id_caixa ?>&tab=fechamento" class="header__caixa-btn">DASHBOARD</a>
    ...
    <nav class="header__nav-mobile" id="headerNavMobile">
        <a href="caixa-aberto-dashboard.php?id=<?= $id_caixa ?>&tab=fechamento" class="header__link">DASHBOARD</a>
